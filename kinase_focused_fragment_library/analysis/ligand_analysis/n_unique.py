...
out_file_name = combinatorial_library_folder / 'unique.txt'
...
# drop duplicates
unique_inchis_ids = list(all_inchis.drop_duplicates().index)
print('Number of unique recombined molecules:', len(unique_inchis_ids))

# save indices of unique recombined molecules
np.savetxt(out_file_name, unique_inchis_ids, fmt='%d')