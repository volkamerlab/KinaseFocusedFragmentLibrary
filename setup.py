...
setup(
    ...
    entry_points={
            "console_scripts": [
                ...
                "kffl-chembl=kinase_focused_fragment_library.ligand_analysis.cli:prepare_chembl",
                "kffl-ligand-analysis=kinase_focused_fragment_library.ligand_analysis.cli:analyze_combinatorial_library",
            ],
        },
